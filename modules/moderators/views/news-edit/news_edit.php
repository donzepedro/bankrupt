...
<div class="row">
    <div class="col-3 mt-5 text-center">
        <img class="img-fluid" id="image_upload_preview" style="min-height: 300px" src= "<?=str_replace('../web', '',$news->img_path)?>">
        <div class='col '><?= $form->field($imgupload, 'imageFile')->fileInput(['id' => 'inputFile', 'class' => 'imgloadbtn'])->label('') ?></div>
        <div class="d-flex justify-content-start">
        <div class="my-5 mx-3 p-1"><?= Html::submitButton('Сохранить изменения', ['class' => 'btn btn-success', 'name' => 'Create-button']) ?></div>
