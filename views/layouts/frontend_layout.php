...
elseif(str_contains(\Yii::$app->request->url,'/am-registration'))  $am_page=' active';
$img_path ='/img/front/';
...
<header class="header-top pt-3">
    <?php
//    $user = Yii::$app->user->isGuest ? '':"<a class='ml-1' href='am-login/log-out/'>Выход</a>";
    $user = Yii::$app->user->isGuest ? '': 'Выход';
    $ProfileLoginPath = Yii::$app->user->isGuest ? '/am-login' : '/am-profile/';
                            NavBar::begin([
                         ...
                         </svg>', 'url' => [$ProfileLoginPath]],
                                    ['label' => $user,'url'=>'/am-login/log-out/','linkOptions'=>['class'=>' active']]
//                                  
                                ],
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-12 order-lg-0 order-md-1 order-sm-1 social-mobil-block">
                ...
                <div class="footer-social-flex">
                    ...
                    <a href="<?= YOUTUBE ?>" class="social-svg">
                        <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M16.5 0C7.38871 0 0 7.38871 0 16.5C0 25.6113 7.38871 33 16.5 33C25.6113 33 33 25.6113 33 16.5C33 7.38871 25.6113 0 16.5 0ZM8 12C8 10.8954 8.89543 10 10 10H24C25.1046 10 26 10.8954 26 12V21.9091C26 23.0137 25.1046 23.9091 24 23.9091H10C8.89543 23.9091 8 23.0137 8 21.9091V12ZM20.7916 16.908C21.1907 17.1137 21.1907 17.6136 20.7916 17.8193L15.4728 20.5608C15.064 20.7715 14.5455 20.5167 14.5455 20.1051V14.6222C14.5455 14.2106 15.064 13.9558 15.4728 14.1665L20.7916 16.908Z" fill="#3951D2"/>
                        </svg>
                    </a>
                </div>
