...
<section class="three-easy-steps">
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12">
				<p class="main-text-p2 width-text text-center">Специалистов по выдаче кредитов становится больше с каждым годом,
					как и обанкротившихся физических и юридических лиц. Для этого и разработан наш сайт, чтобы вы смогли легко
					найти арбитражного управляющего, представляющего ваши интересы в суде и защищающего их.
				</p>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="difficulties-wrapper">
					<h2 class="main-name-h2">Вам требуется помощь арбитражного управляющего?</h2>
					...
					<div class="difficulties-flex">
						...
						<div class="difficulties-info">
							<h4 class="main-name-h4">Наш сервис поможет вам</h4>
...
</g></svg></span>Найти представителя ваших интересов</a></li>
								<li><a href="#" class="main-text-p3"><span><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="512" height="512" x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve"><g>
<g xmlns="http://www.w3.org/2000/svg">
	<g>
		<path d="M504.502,75.496c-9.997-9.998-26.205-9.998-36.204,0L161.594,382.203L43.702,264.311c-9.997-9.998-26.205-9.997-36.204,0    c-9.998,9.997-9.998,26.205,0,36.203l135.994,135.992c9.994,9.997,26.214,9.99,36.204,0L504.502,111.7    C514.5,101.703,514.499,85.494,504.502,75.496z" fill="#fafafa" data-original="#000000" style=""/>
...
</g></svg></span>Сотрудничать безопасно и по закону РФ</a></li>
								<li><a href="#" class="main-text-p3"><span><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="512" height="512" x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve"><g>
<g xmlns="http://www.w3.org/2000/svg">
	<g>
		<path d="M504.502,75.496c-9.997-9.998-26.205-9.998-36.204,0L161.594,382.203L43.702,264.311c-9.997-9.998-26.205-9.997-36.204,0    c-9.998,9.997-9.998,26.205,0,36.203l135.994,135.992c9.994,9.997,26.214,9.99,36.204,0L504.502,111.7    C514.5,101.703,514.499,85.494,504.502,75.496z" fill="#fafafa" data-original="#000000" style=""/>
...
</g></svg></span>Работать на взаимовыгодных условиях</a></li>
							</ul>
						</div>
					</div>
				</div>
