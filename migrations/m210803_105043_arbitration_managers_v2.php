    ...
    public function safeUp(){
     $this->execute("CREATE TABLE arbitration_manager
                            (
                             ...
                             bankrupt_categories      tinyint(2) NOT NULL COMMENT 'categories of clients(bankrupt/creditor) 0-phys 1-legal 2-both' ,
                             debtor_categories          tinyint(2) NOT NULL COMMENT 'categories of debtors(bankrupt/creditor) 0-phys 1-legal 2-both' ,
