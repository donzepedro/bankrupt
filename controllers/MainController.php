...
class MainController extends Controller{
    ...
    public $layout = 'frontend_layout.php';
     public $commentInfo=[
            ...
            8=>[
              "capture"=>'После развода...',  
              "textComment"=>'После развода несколько лет назад на протяжении многих месяцев боролась с долгами мужа, накопленными за время совместной жизни. Так получилось. Думала, что найду силы рассчитаться, но в последние полгода пришлось уволиться с работы, поэтому была просто не в состоянии выплачивать кредиты. К счастью, центр «Атра» помог абсолютно на законных основаниях списать долги, представляя мои интересы. Уверена, что в центре по банкротству и вам помогут.',  
              "name"=>'Ирина',  
            ],
            9=>[
              "capture"=>'Действенная процедура',  
              "textComment"=>'Знал уже о действенной процедуре банкротства, поэтому когда начались проблемы в бизнесе, а долги стали копиться сотнями тысяч, то незамедлительно подал через «Атру» на банкротство уже в статусе физического лица. Пришлось немного подождать, но зато избавился от задолженностей, и теперь могу заниматься спокойно новым проектом. Пусть и не бизнесом.',  
              "name"=>'Константин',  
            ],
            10=>[
              "capture"=>'Всей семьей накопили долги',  
              "textComment"=>'Всей семьей накопили в последние годы долги. Вплоть до микрозаймов. Сильно замучили звонками коллекторы. Терять было уже нечего, поэтому решила попробовать стать банкротом. Выяснилось, что здесь не только нет ничего страшного, как мне казалось. Думала, что вообще в тюрьму посадят за долги. Но нет. От этой проблемы избавилась, а вслед за мной банкротство оформили и сын, и муж.',  
              "name"=>'Оксана',  
            ],
            11=>[
              "capture"=>'Потратил почти год на процедуру.',  
              "textComment"=>'Потратил почти год на процедуру, однако сотрудники «Атры» не только помогли избавиться от задолженности, но и сохранить даже имущество. Думал, что последнее сделать не получится, потому что долгов было на несколько миллионов рублей. Приятного в банкротстве мало, но всем советую, если выхода нет.',  
              "name"=>'Николай П.',  
            ],
            12=>[
              "capture"=>'Компания «Атра» сразу внушила мне доверие',  
              "textComment"=>'Компания «Атра» сразу внушила мне доверие, когда у меня возникли проблемы с долгами по ряду потребительских кредитов. Платить их не получалось, потому что невыплаты попали еще на время моего поиска работы. В итоге в «Атре» меня проконсультировали, помогли собрать документы, подать заявление на банкротство, а уже меньше, чем через год меня признали банкротом. Самое главное, что услуга оказалась недорогой!',  
              "name"=>'Светлана',  
            ],
            13=>[
              "capture"=>'Так получилось, что накопил долги',  
              "textComment"=>'Так получилось, что накопил долги. Суд длился порядка года, чтобы признать мебя банкротом. Спасибо компании «Атра», что не только помогла сэкономить денег (я заплатил на признание банкротства раз в семь меньше, чем отдал бы по кредитным долгам), но и подсказала нюансы, связанные с блокировкой карт и счетов в банках, пока идет процедура. Таких нюансов я не знал. Видно, что в «Атре» работают на результат и готовы помогать людям! Спустя 13 месяцев я стал свободным от долгов человеком.',  
              "name"=>'Евгений',  
            ],
        ];
